...
const End = ['today.','tomorrow.','every day.','forever.','for eternity.','or something.','or whatever.','or don\'t.'];
...
const GenerateWisdom = () => {
    ...
    //Assemble string using random word parts, and output.
    const wisdom = `The ancient ones have spoken!\nThey say: ${Beginning[randBeg]} ${Middle[randMid]} ${End[randEnd]}`;
    return wisdom;
}
